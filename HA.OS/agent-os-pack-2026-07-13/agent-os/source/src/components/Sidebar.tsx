...
import { LayoutGrid, Brain, TrendingUp, Columns3, NotebookText, Film, Building2, Workflow, MessagesSquare, Image as ImageIcon, Gamepad2, Music2, Network, Clapperboard, Repeat, Cpu, LayoutDashboard, Palette, GripVertical, Eye, EyeOff, SlidersHorizontal, Check, SquareTerminal, Route, Scissors, Shirt } from "lucide-react";
...
const NAV: NavItem[] = [
  ...
  { href: "/productline", label: "Product Line", icon: <Shirt size={16} />, accent: "#d4af37", dim: "rgba(212,175,55,0.16)" },
